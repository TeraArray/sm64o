/// next time PLEASE add elseif statements
/// <3 Solid Chris
using System;
...
namespace SM64O {
    public static class Characters {
        ...
        private static bool isPrintable(char c) {
            if (char.IsLetterOrDigit(c)) || (Array.IndexOf(_printables, c) != -1) return true;
            return false;
        }
